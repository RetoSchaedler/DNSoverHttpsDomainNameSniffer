...
Tested on Debian/Ubuntu/Kali/Fedora Linux 64-bit based OS, as well as Raspberry Pi 4+5 Arm64 and Nvidia-Jetson.
Technical Notes
Administrator Privileges Required
Root or administrator rights are necessary to run the software.
Security and Precision
Designed for maximum transparency and control over network data, my software ensures reliable performance.
...
# open webbrowser http://localhost:8089/
